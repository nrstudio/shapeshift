...
export const beerdata = [
	{
		...
		type: 'Flagship IPA',
		alc: '6.2% alc/vol',
		description: 'Our flagship IPA was brewed with a delicious dose of galaxy hops and flaked oats and then conditioned on citra hops to give the beer a powerful aroma and satiating mouthfeel. We hope you enjoy it by a campfire,or listening to your favorite music with the people you love.'
	},
	{
		name: 'Bloom',
	...
	},
	{
		...
		alc: '5.2% alc/vol',
		description: "With a name like 'Jupiter', it's not the size of the alc/vol, but the size of the flavor. We added apricot purée to the fermentation and we can confirm that in our humble opinion, it's the best flavoring to add to any sour beer."
	},
		{
		name: 'Earth',
